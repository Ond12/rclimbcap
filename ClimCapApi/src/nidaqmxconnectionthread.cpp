...
{
	if (this->m_acquisitionTask != nullptr)
	{
		this->stopAcquisition();
		delete this->m_acquisitionTask;
		qDebug("Clearing acquisition task");
	}
}
...
void NidaqmxConnectionThread::setTriggerEnable(bool enable)
{
	this->m_enableStartTrigger = enable;
}
