#fichier principale s occupant de la gestion et du traitement des donnees acquisent
...
class Sensor:
    ...
    def set_is_compression_flip(self,value):
        self.isCompressionFlip = bool(value)

    def to_string(self):
        print(self.sensor_name + " id: " + str(self.sensor_id) + " compression: " + str(self.isCompressionFlip  ))
