#fichier pour une fonctionnalité experimentale de sonification
#cette classe envoie les donnees de forces dans un canal osc
#ce canal est relie a l'application de sonification dev par james leonard
