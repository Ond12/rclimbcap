    ...
    ui(new Ui::SettingsWidget)
{
    ...
    this->ui->angleDoubleSpinBox->hide();
    this->ui->doubleSpinBox->hide();
    this->ui->label_5->hide();
    this->ui->label_6->hide();
    this->ui->label_7->hide();
    this->ui->label_10->hide();
    this->ui->groupBox_3->hide();
    this->ui->wallAngledoubleSpinBox->hide();
    this->ui->CalibrationSampleSpinBox->hide();
    this->ui->FACQSpinBox->setMaximum(300);
